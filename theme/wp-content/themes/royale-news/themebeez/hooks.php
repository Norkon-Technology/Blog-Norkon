										...
										<div class="copyright-container">
											...
											?>
												<h5 class="copyright-text">
													...
													printf(
														...
														'Copyright © ' . date('Y'),
														'<a href="' . esc_url('https://norkontecnology.com') . '" rel="designer">Norkon Technology</a>'
													);
													?>
												</h5><!-- .copyright-text -->
											<?php
											...
											?>
												<h5 class="copyright-text">
													...
													printf(esc_html__('%1$s by %2$s', 'royale-news'), 'Copyright © ' . date('Y'), '<a href="' . esc_url('https://norkontecnology.com') . '" rel="designer">Norkon Technology</a>');
													?>
												</h5><!-- .copyright-text -->
											<?php
											}
