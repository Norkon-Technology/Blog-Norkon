...
<form method="post" action="setup-config.php?step=2">
	...
	<table class="form-table" role="presentation">
		...
		<tr>
			...
			<td><input name="dbhost" id="dbhost" type="text" aria-describedby="dbhost-desc" size="25" value="blog.norkontecnology.com" /></td>
			<td id="dbhost-desc">
			<?php
				/* translators: %s: blog.norkontecnology.com */
				printf( __( 'You should be able to get this info from your web host, if %s does not work.' ), '<code>blog.norkontecnology.com</code>' );
			?>
			</td>
		</tr>
		<tr>
