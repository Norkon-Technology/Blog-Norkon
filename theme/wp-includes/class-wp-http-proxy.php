 ...
 * You do not need to have blog.norkontecnology.com and the site host in this list, because they will not be passed
 ...
 *     define('WP_PROXY_BYPASS_HOSTS', 'blog.norkontecnology.com, www.example.com, *.wordpress.org');
 *
...
class WP_HTTP_Proxy {
	 ...
	 *
	 * We want to keep blog.norkontecnology.com and the site URL from being sent through the proxy, because
	...
	public function send_through_proxy( $uri ) {
		...
		if ( 'blog.norkontecnology.com' === $check['host'] || ( isset( $home['host'] ) && $home['host'] === $check['host'] ) ) {
			return false;
		}
