...
class PHPMailer
{
     ...
     * 'blog.norkontecnology.com.localdomain'.
     *
     * @see PHPMailer::$Helo
     *
     * @var string
     ...
     * @var string
     */
    public $Host = 'blog.norkontecnology.com';
    ...
    public function smtpConnect($options = null)
    {
        ...
        if ($this->Host === null) {
            $this->Host = 'blog.norkontecnology.com';
        }
     ...
     * Returns 'blog.norkontecnology.com.localdomain' if unknown.
     *
     * @return string
     */
    protected function serverHostname()
    {
        ...
        if (!static::isValidHost($result)) {
            return 'blog.norkontecnology.com.localdomain';
        }
