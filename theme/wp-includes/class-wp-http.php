...
class WP_Http {
	 ...
	 * file and this will only allow blog.norkontecnology.com and your site to make requests. The constant
	...
	public function block_request( $uri ) {
		...
		if ( 'blog.norkontecnology.com' === $check['host'] || ( isset( $home['host'] ) && $home['host'] === $check['host'] ) ) {
			 ...
			 *
			 * A local request is one to `blog.norkontecnology.com` or to the same host as the site itself.
			 *
			 * @since 2.8.0
			 *
