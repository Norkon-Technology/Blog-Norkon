 ...
 * const authority2 = getAuthority( 'https://blog.norkontecnology.com:8080/test/' ); // 'blog.norkontecnology.com:8080'
 * ```
 *
 ...
 * @example
 * ```js
 * const path1 = getPath( 'http://blog.norkontecnology.com:8080/this/is/a/test?query=true' ); // 'this/is/a/test'
 ...
 * @example
 * ```js
 * const queryString = getQueryString( 'http://blog.norkontecnology.com:8080/this/is/a/test?query=true#fragment' ); // 'query=true'
 * ```
 *
 ...
 * @example
 * ```js
 * const pathAndQueryString1 = getPathAndQueryString( 'http://blog.norkontecnology.com:8080/this/is/a/test?query=true' ); // '/this/is/a/test?query=true'
 ...
 * @example
 * ```js
 * const fragment1 = getFragment( 'http://blog.norkontecnology.com:8080/this/is/a/test?query=true#fragment' ); // '#fragment'
 ...
 * @example
 * ```js
 * const filename1 = getFilename( 'http://blog.norkontecnology.com:8080/this/is/a/test.jpg' ); // 'test.jpg'
